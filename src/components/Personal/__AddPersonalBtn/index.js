...
function AddPersonalBtn ({data, setData}){
    ...
    return (
        <div>
            <form action="/" onSubmit={handleAddBtnClick} className="add-user-form" >
                <input className="add-user-form__input" onChange={onLastNameTextChange} value={userLast} placeholder="Фамилия" />
                <input className="add-user-form__input" onChange={onFirstNameTextChange} value={userFirst} placeholder="Имя" />
                <input className="add-user-form__input" onChange={onAdressTextChange} value={userAdress} placeholder="Адрес" />
                <div className="add-user-form__radio" onChange={onRegionChange}>
                    <div>
                        <input type="radio" name="region" value="N" id="region2" defaultChecked/>
                        <label htmlFor="region2">Север</label>
                    </div>
                    <div>
                        <input type="radio" name="region" value="S" id="region1" />
                        <label htmlFor="region1">Юг</label>
                    </div>
                </div>
                <div className="add-user-form__radio" onChange={onGroupChange}>
                    <div>
                        <input type="radio" name="group" value="М" id="group1" defaultChecked />
                        <label htmlFor="group1">Исаков</label>
                    </div>
                    <div>
                        <input type="radio" name="group" value="К" id="group2" />
                        <label htmlFor="group2">Игнатьев</label>
                    </div>
                </div>
                <div className="add-user-form__checkbox">
                    <input type="checkbox" id="isGeodesist" checked={isGeodesist} onChange={handleCheckboxChange} />
